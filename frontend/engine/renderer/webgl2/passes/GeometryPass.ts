...
export type GeometryRenderInput = {
  module: WasmModule;
...
export class GeometryPass {
  ...
  private resources: GeometryPassResources | null = null;
  ...
  public updateBuffer(module: WasmModule, positionMeta: BufferMeta): void {
    if (!this.resources) return;
  ...
  public render(input: GeometryRenderInput): void {
    if (!this.resources) return;
    const { gl } = this;
