...
import { TextInputCoordinator, type CoordinatorCallbacks, type StyleDefaults } from './TextInputCoordinator';
...
describe('TextInputCoordinator', () => {
    ...
    beforeEach(() => {
        ...
        const defaults: StyleDefaults = {
           fontId: 0, fontSize: 16, colorRGBA: 0, flags: TextStyleFlags.None
        };
