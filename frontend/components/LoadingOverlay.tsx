...
const LoadingOverlay: React.FC = () => {
  ...
  return (
    <div
      ...
      aria-live="assertive"
    >
      <div className={`flex flex-col items-center gap-4 p-8 rounded-2xl bg-slate-800/80 border border-slate-700/50 shadow-2xl backdrop-blur-xl transform transition-all duration-300 ${isVisible ? 'scale-100 translate-y-0' : 'scale-95 translate-y-4'}`}>
        {/* Spinner */}
