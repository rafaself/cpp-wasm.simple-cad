    ...
    PickCandidate& outCandidate)
{
    ...
    if (const RectRec* r = entities.getRect(id)) {
        ...
        outCandidate.elevation = std::isfinite(r->elevationZ) ? r->elevationZ : 0.0f;
    ...
    // 2. CIRCLE (actually ellipse)
        ...
        outCandidate.elevation = std::isfinite(c->elevationZ) ? c->elevationZ : 0.0f;
    ...
    // 3. LINE
        ...
        outCandidate.elevation = std::isfinite(l->elevationZ) ? l->elevationZ : 0.0f;
    ...
    // 4. POLYLINE
        ...
        outCandidate.elevation = std::isfinite(pl->elevationZ) ? pl->elevationZ : 0.0f;
    ...
    // 5. TEXT
        ...
        outCandidate.elevation = std::isfinite(t->elevationZ) ? t->elevationZ : 0.0f;
    ...
    // 6. POLYGON (Regular)
        ...
        outCandidate.elevation = std::isfinite(p->elevationZ) ? p->elevationZ : 0.0f;
    ...
    // 7. ARROW
        ...
        outCandidate.elevation = std::isfinite(a->elevationZ) ? a->elevationZ : 0.0f;
        // Shaft
